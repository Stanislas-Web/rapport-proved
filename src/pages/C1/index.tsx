...
import TableC1 from './components/tableC1';


const C1 = () => {
  const { c1s } = useSelector((state: RootState) => state.c1s);
  ...
  const exportAdminDataToExcel = () => {
    ...
    const formattedData = c1s.map((item: any, index: any) => {
  ...
  return (
    <>
      <div className="mx-auto max-w-270">
        ...
        <Breadcrumb pageName="Première visite (C1)" />
